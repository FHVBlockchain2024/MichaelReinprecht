//Technically, the Frontend should handle everything, so everything you have to do is navigate to "Gamble/frontend/gamble-frontend" and run the command "npm run start" to start the react frontend.
